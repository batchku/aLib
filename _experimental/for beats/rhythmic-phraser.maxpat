...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 266.0, 168.0, 44.0, 17.0 ],
					"text" : "round 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 266.0, 132.0, 74.0, 17.0 ],
					"text" : "vexpr $f1 * 127."
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 514.0, 270.0, 32.5, 20.0 ],
									"text" : "- 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 581.0, 403.0, 24.0, 20.0 ],
									"text" : "t 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 163.0, 158.0, 54.0, 20.0 ],
									"text" : "gate 2 1"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 173.0, 203.0, 34.0, 20.0 ],
									"text" : "t b b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 199.0, 60.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 199.0, 107.0, 86.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 477.0, 577.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 318.0, 577.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 360.0, 108.0, 77.0, 18.0 ],
									"text" : "-1 -2 -3 -4 -5"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 291.0, 364.0, 32.5, 20.0 ],
									"text" : "t l l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "bang", "bang", "" ],
									"patching_rect" : [ 426.0, 402.0, 46.0, 20.0 ],
									"text" : "t b b l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 426.0, 286.0, 57.0, 20.0 ],
									"text" : "zl slice 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "bang", "", "", "int" ],
									"patching_rect" : [ 268.0, 164.0, 59.5, 20.0 ],
									"text" : "t b l l 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "int", "", "", "int" ],
									"patching_rect" : [ 507.0, 332.0, 77.0, 20.0 ],
									"text" : "counter 1 10"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 477.0, 233.0, 39.0, 20.0 ],
									"text" : "zl len"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 291.0, 432.0, 57.0, 20.0 ],
									"text" : "zl slice 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 291.0, 322.0, 51.0, 20.0 ],
									"text" : "zl rot -1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 291.0, 286.0, 40.0, 20.0 ],
									"text" : "zl reg"
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 363.0, 382.0, 384.0, 324.0 ],
									"source" : [ "obj-10", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 255.0, 552.0, 93.0, 209.0 ],
									"source" : [ "obj-22", 0 ]
								}
...
,
					"patching_rect" : [ 65.0, 314.0, 49.0, 20.0 ],
...
,
														...
														"boxes" : [ 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "float" ],
																	"patching_rect" : [ 50.0, 285.5, 32.5, 20.0 ],
																	"text" : "f"
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "int" ],
																	"patching_rect" : [ 87.0, 219.0, 46.0, 20.0 ],
																	"text" : "accum"
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 87.0, 144.0, 27.0, 20.0 ],
																	"text" : "iter"
																}
...
,
													"patching_rect" : [ 305.0, 249.0, 50.0, 20.0 ],
													"saved_object_attributes" : 													{
														"default_fontface" : 0,
														"default_fontname" : "Arial",
														"default_fontsize" : 12.0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 294.0, 613.0, 88.0, 20.0 ],
									"text" : "vexpr $f1 * $f2"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 597.0, 495.0, 215.0, 47.0 ],
...
,
		"dependency_cache" : [ 			{
				"name" : "ali.sum.pat",
				"bootpath" : "/Users/ali/Desktop/Unfrozen Max Device Files/time.spewer.amxd",
				"patcherrelativepath" : "../../../../../../Desktop/Unfrozen Max Device Files/time.spewer.amxd",
				"type" : "maxb",
				"implicit" : 1
			}
, 			{
				"name" : "list-maker.pat",
				"bootpath" : "/Users/ali/Dropbox/for-max/3rd Party for Max OS X/aLib/_aLib 1.0 11.1.1/for lists",
				"patcherrelativepath" : "../../_aLib 1.0 11.1.1/for lists",
				"type" : "maxb",
				"implicit" : 1
			}
, 			{
				"name" : "var-init.pat",
				"bootpath" : "/Users/ali/Dropbox/for-max/3rd Party for Max OS X/aLib/_aLib 1.0 11.1.1/for crap",
				"patcherrelativepath" : "../../_aLib 1.0 11.1.1/for crap",
				"type" : "maxb",
				"implicit" : 1
			}
, 			{
				"name" : "list-difference.maxpat",
				"bootpath" : "/Users/ali/Desktop/Unfrozen Max Device Files/time.spewer.amxd",
				"patcherrelativepath" : "../../../../../../Desktop/Unfrozen Max Device Files/time.spewer.amxd",
				"type" : "JSON",
				"implicit" : 1
...
, 			{
				...
				"bootpath" : "/Users/ali/Dropbox/for-max/3rd Party for Max OS X/aLib/_aLib 1.0 11.1.1/for controllers/gluion",
				"patcherrelativepath" : "../../_aLib 1.0 11.1.1/for controllers/gluion",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
